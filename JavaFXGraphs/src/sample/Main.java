...
public class Main extends Application {
    ...
    public void start(Stage stage) {
        ...
        var equationData = controller.getData(N_SAMPLES); // get the computed data from the controller
        ...
        var series = new XYChart.Series<>(FXCollections.observableList(equationData)); // creates the series (all the data)
